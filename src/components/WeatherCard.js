...
return(
    ...
    <div className="col-11  col-lg-9 bg-dark bg-gradient bg-opacity-75 p-2 rounded shadow">
        <h4 className=""> Weather for today ({ new Date().getDate() + "-"+  (new Date().getMonth()*1+1)})</h4>
        {console.log(weather)}
        <div><p>Temperature: {weather.current.temp}° <ThermometerIcon temp={weather.current.temp}/></p></div>
        <div className="flex-row d-flex align-items-center"><p className="m-0 me-3">Wind: {weather.current.wind_speed} km/h </p> <div className="d-flex flex-column align-items-center justify-content-center"><svg xmlns="http://www.w3.org/2000/svg" style={arrowDirection}     width="16" height="16" fill="currentColor" class="bi bi-arrow-up-circle" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"/>
</svg>
<p className="m-0 mt-1">{weather.current.wind_deg}°</p></div><svg className="ms-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wind" viewBox="0 0 16 16">
